##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.14.1] date: [Fri Oct 08 22:41:01 CST 2021]
##########################################################################################################################
...
all: $(BUILD_DIR)/$(TARGET).elf $(BUILD_DIR)/$(TARGET).hex $(BUILD_DIR)/$(TARGET).bin
	rm $(BIN_DIR) -rf
	mkdir $(BIN_DIR) 
	cp $(BUILD_DIR)/$(TARGET).elf $(BIN_DIR)/$(TARGET).elf -rf
	cp $(BUILD_DIR)/$(TARGET).hex $(BIN_DIR)/$(TARGET).hex -rf
	cp $(BUILD_DIR)/$(TARGET).bin $(BIN_DIR)/$(TARGET).bin -rf
